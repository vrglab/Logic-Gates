...
public class LogicGateBlockEntityTypes {
    ...
    public static Object PULSE_GEN_ENTITY_TYPE = Registry.RegisterBlockEntityType("pulse_gen_entity_type", LogicGatesMod.MOD_ID, PulseGenEntityType::new, LogicGateBlockEntityBlocks.PULSE_GEN_BLOCK);

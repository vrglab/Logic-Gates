...
public class ClientModEventSubscriber {
    ...
    public static void registerRenderTypes(FMLClientSetupEvent event) {
        event.enqueueWork(() -> {
            ...
            ItemBlockRenderTypes.setRenderLayer((Block)Utils.convertToMcSafeType(LogicGateBasicBlocks.NAND_GATE_BLOCK), RenderType.cutout());
            ItemBlockRenderTypes.setRenderLayer((Block)Utils.convertToMcSafeType(LogicGateBasicBlocks.NOR_GATE_BLOCK), RenderType.cutout());
        });
    }
}
